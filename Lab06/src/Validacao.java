...
public class Validacao {
    ...
    public static Veiculo retornarVeiculo(String placa, ArrayList <Veiculo> listaVeiculos){
        int idx = indiceDoVeiculoNaLista(placa, listaVeiculos);
        return listaVeiculos.get(idx);
    }

    public static Condutor retornarCondutor(String cpf, ArrayList <Condutor> listaCondutor){
        int idx = indiceDoCondutorNaLista(cpf, listaCondutor);
        return listaCondutor.get(idx);
    }

    public static Seguro retornarSeguro(int id, ArrayList <Seguro> listaSeguros){
        int idx = indiceDeSeguroNaLista(id, listaSeguros);
        return listaSeguros.get(idx);
    }

    public static Sinistro retornarSinistro(int id, ArrayList <Sinistro> listaSinistros){
        int idx = indiceDeSinistroNaLista(id, listaSinistros);
        return listaSinistros.get(idx);
    }

    public static Frota retornarFrota(int code, ArrayList <Frota> listaFrotas){
        int idx = indiceDaFrotaNaLista(code, listaFrotas);
        return listaFrotas.get(idx);
    }

    public static Seguradora retornarSeguradora(String cpfSeguradora, ArrayList <Seguradora> listaSeguradoras){
        int idx = indiceDaSeguradoraNaLista(cpfSeguradora, listaSeguradoras);
        return listaSeguradoras.get(idx);
    }

    public static Cliente retornarCliente(String cpfCliente, ArrayList <Cliente> listaClientes){
        int idx = indiceDeClienteNaLista(cpfCliente, listaClientes);
