...
public class MainClass {
    ...
    public static Cliente inserirCliente(Seguradora seguradora) {
        ...
        if (p == 0) { //PESSOA FÍSICA
            String nome, telefone, email, endereco, cpf, genero, classeEconomica, educacao;
            ...
            genero, educacao, classeEconomica, dataNascimento, listaVeiculos);
            return cliente;
    ...
    public static void main(String[] args){
        ...
        ClientePF cliente1 = new ClientePF("Pedro da Silva", "(019)92314-1242", "oieoieoie@gmail.com","Rua Fisica 87", "847.850.640-30", "Masculino", "Superior completo", "Rico", Validacao.p("25/12/2003"), listaVeiculo1);
